...
/*
	if (is_array($page_settings_basket)){
		foreach ($page_settings_basket as $setting_name => $setting_value)
        {
            if ($setting_name == "basket_block") {
                require_once("./blocks/block_basket.php");
...
/*
	$page_name_basket = "basket";
	$layout_id_basket = 0;
	$page_settings_basket = va_page_settings($page_name_basket, $layout_id_basket);
