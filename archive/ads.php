...
*/
	...
	$sql  = " SELECT ac.category_name,ac.friendly_url,ac.short_description,ac.full_description,";
	$sql .= " ac.category_path,ac.parent_category_id,ac.image_small, ac.image_large, ac.total_views ";
	if (isset($site_id)) {
	...
	$sql .= " AND ac.category_id = " . $db->tosql($category_id, INTEGER, true, false);
