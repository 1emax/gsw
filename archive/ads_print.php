...
*/
	...
	$sql .= " u.login, u.name AS user_name, u.first_name, u.last_name, ic.category_id, ";
	...
	$sql .= " INNER JOIN " . $table_prefix . "ads_assigned ic ON i.item_id=ic.item_id) ";
	...
	$sql .= " WHERE ic.category_id = " . $db->tosql($category_id, INTEGER);
